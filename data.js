// Current Affairs Command Center 2026 — 100% Zero-Redundancy Dataset (99 Items)
...
const CA_SECTION_DRILLS = {
  "sec1": {
    retrievals: [
      "What was the gross GST collection figure and YoY growth percentage in July 2026?",
      "What is the mandatory bank lending pool quota for small/mid MFIs under CGSMFI 2.0?",
      "Until which tax year does the Taxation (Amendment) Bill 2026 extend tax exemptions for foreign electronics capital goods suppliers?",
      "In which fiscal year is India's GDP projected to cross  trillion according to the IMF?",
      "What floor price per share was fixed for LIC's 6.5% Offer for Sale (OFS)?"
    ],
    coverTests: [
      "1. Gross GST July 2026 amount & YoY growth?",
      "2. CGSMFI 2.0 mandatory bank pool & max loan AUM cap %?",
      "3. Extended tax exemption sunset year for electronics capital goods suppliers?",
      "4. Projected nominal GDP in USD by FY29?",
      "5. LIC OFS floor price per share?"
    ],
    answers: "1. ₹2.11 Trillion, 15.4% | 2. 15% of corpus, 20% of AUM | 3. March 31, 2041 | 4. USD 5.1 Trillion | 5. ₹382 per share",
    examAngles: [
      "Gross GST July 2026 grew 15.4% to reach ₹2.11 trillion.",
      "CGSMFI 2.0 mandates banks to lend at least 15% of corpus to small/mid MFIs.",
      "Taxation Bill 2026 extends electronics capital goods tax exemption sunset to March 31, 2041."
  ...
  "sec2": {
    retrievals: [
      "How many circulars were consolidated into how many Master Directions by RBI's Department of Supervision?",
      "What is the strict RBI mandate regarding detected counterfeit notes at bank counters?",
      "What is the maximum number of buyers allowed in a FY for unlisted secondary share sales to avoid being a deemed public issue?",
      "What is the annual fee formula for insurance intermediaries under IRDAI's revised norms?",
      "What are the maximum penalty caps under DPDPA 2023 for data security failures and breach notification failures?",
      "What is the current repo rate and projected FY27 GDP growth rate announced in RBI's 62nd MPC statement?"
    ],
    coverTests: [
      "1. Master Directions count & consolidated circulars count?",
      "2. Unlisted share deal buyer cap per FY?",
      "3. IRDAI Intermediary annual fee formula & Infra SPV investment cap?",
      "4. DPDPA maximum security failure penalty cap?",
      "5. RBI Repo Rate & FY27 GDP growth projection?",
      "6. CAS Order Entry II window (no modification phase)?"
    ],
    answers: "1. 64 Master Directions, 628 circulars | 2. 200 buyers per FY | 3. Higher of ₹10,000 or 0.04% commission; 20% in AA+ Infra SPVs | 4. ₹250 crore | 5. 5.25% Repo Rate, 6.7% GDP growth | 6. 3:25 PM to 3:30 PM",
    examAngles: [
      "RBI consolidated 628 circulars into 64 Master Directions.",
      "DPDPA 2023 caps security failure penalties at ₹250 crore.",
      "RBI maintained repo rate at 5.25% and projected FY27 GDP growth at 6.7%."
